                    ...
                    <Card className='mt-3 ps-2 border-0 shadow-sm'>
                        {
                            (post)&&(
                                <CardBody>
                                    <CardText>Posted By <b>{post.user.name}</b> on <b>{printDate}</b></CardText>
                                    <CardText>
                                    ...
                                    <div className='image-container mt-4 shadow' style={{maxWidth:"50%"}}>
                                        <img src={BASE_URL+'/post/image/'+post.imageName} alt={post.title} className='img-fluid'/>
                                    </div>
                                    <div className='text'>Github Link:</div>
                                    <CardText className='mt-5' dangerouslySetInnerHTML={{__html:post.githubLink}}>
                                    </CardText>
